...
public class DialogPerhitunganAHP extends javax.swing.JDialog {
        ...
        String noIdAlternatif, namaMotorAlternatif, merekAlternatif, hargaOtrAlternatif,
                        kapasitasMesinAlternatif, iritBahanBakarAlternatif, desainModelAlternatif;
        ...
        public void getPenilaian() {
                ...
                } else if (hargaOtrAlternatif.contains("MENENGAH")) {
                        nilaiAlternatif = SubK.prioritasSub3x3[1] * kriteria.prioritas[0];
                        totalNilai += nilaiAlternatif;
                } else if (hargaOtrAlternatif.contains("PREMIUM")) {
                ...
                if (kapasitasMesinAlternatif.contains("Kecil")) {
                        ...
                        totalNilai += nilaiAlternatif;
                } else if (kapasitasMesinAlternatif.contains("Sedang")) {
                        nilaiAlternatif = SubK.prioritasSub3x3[1] * kriteria.prioritas[1];
                        totalNilai += nilaiAlternatif;
                } else if (kapasitasMesinAlternatif.contains("Besar")) {
