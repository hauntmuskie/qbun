...
// import java.sql.ResultSet; // Removed - not used
import java.sql.SQLException;
// import java.util.logging.Level; // Removed - not used
// import java.util.logging.Logger; // Removed - not used
import javax.swing.JOptionPane;
import static javax.swing.JOptionPane.ERROR_MESSAGE;
import javax.swing.JRootPane;
// import javax.swing.table.DefaultTableModel; // Removed - not used
...
public class DialogTambahData extends javax.swing.JDialog {
    ...
    public void setDataTabel(String id_motor, String nama_motor, String merek, String harga_otr, String kapasitas_mesin,
            String irit_bahan_bakar, String desain_model, String kategori_harga, String kategori_cc,
            String kategori_irit, String kategori_desain) {
        ...
        cbTingkatMotor.setSelectedItem(kategori_harga);
        tJenisMotor.setText(harga_otr);
        // Components for additional fields would be needed in form
    ...
    protected void kosong() {
        ...
        tMotor.setText("");
        btnG.clearSelection();
        cbTingkatMotor.setSelectedIndex(0);
        // tMenuMotor.setText(""); // Component not defined in form
        tJenisMotor.setText("");
        // tHargaMotor.setText(""); // Component not defined in form
    ...
    private void insertDataPaket() {
        ...
        try {
            ...
            stat.setString(4, tJenisMotor.getText()); // harga_otr
            stat.setString(5, "125 cc"); // Default kapasitas_mesin - would need form field
            stat.setString(6, "50 km/l"); // Default irit_bahan_bakar - would need form field
            stat.setString(7, "Sporty"); // Default desain_model - would need form field
            stat.setString(8, cbTingkatMotor.getSelectedItem().toString()); // kategori_harga
            stat.setString(9, cbmesin.getSelectedItem().toString()); // kategori_cc
            stat.setString(10, cbIritBensin.getSelectedItem().toString()); // kategori_irit
            stat.setString(11, "Sporty/Agresif"); // Default kategori_desain - would need form field
            stat.executeUpdate();
    ...
    private void editDataPaket() {
        try {
            String sql = "UPDATE data_motor set nama_motor=?, merek=?, harga_otr=?, kapasitas_mesin=?, irit_bahan_bakar=?, desain_model=?, kategori_harga=?, kategori_cc=?, kategori_irit=?, kategori_desain=?  WHERE id_motor=?";
            PreparedStatement stat = conn.prepareStatement(sql);
            ...
            stat.setString(3, tJenisMotor.getText()); // harga_otr
            stat.setString(4, "125 cc"); // Default kapasitas_mesin
            stat.setString(5, "50 km/l"); // Default irit_bahan_bakar
            stat.setString(6, "Sporty"); // Default desain_model
            stat.setString(7, cbTingkatMotor.getSelectedItem().toString()); // kategori_harga
            stat.setString(8, cbmesin.getSelectedItem().toString()); // kategori_cc
            stat.setString(9, cbIritBensin.getSelectedItem().toString()); // kategori_irit
            stat.setString(10, "Sporty/Agresif"); // Default kategori_desain
            stat.setString(11, tNoId.getText());
    ...
    private void initComponents() {
        ...
        cbmesin.setModel(new javax.swing.DefaultComboBoxModel<>(
        ...
        cbIritBensin.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- SubKriteria Irit Bensin -",
                        ...
                        .addGroup(jPanel12Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel12Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel12Layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        .addComponent(cbmesin, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                Short.MAX_VALUE)
                                                        .addComponent(cbIritBensin, 0, 341, Short.MAX_VALUE)
                                                        .addComponent(cbHarga, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                Short.MAX_VALUE)))
                                        .addGroup(jPanel12Layout.createSequentialGroup()
                                                .addComponent(jLabel27)
                                                .addGap(23, 23, 23)
                                                .addComponent(cbDesain, 0, 341, Short.MAX_VALUE)))
                                .addContainerGap()));
        jPanel12Layout.setVerticalGroup(
                jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel12Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jLabel24)
                                        .addComponent(cbHarga, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel25)
                                        .addComponent(cbmesin, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel26)
                                        .addComponent(cbIritBensin, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel27)
                                        .addComponent(cbDesain, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        tJenisMotor.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N

        rbYamaha.setBackground(new java.awt.Color(22, 65, 53));
        btnG.add(rbYamaha);
        ...
        rbHonda.setBackground(new java.awt.Color(22, 65, 53));
        btnG.add(rbHonda);
        ...
        cbTingkatMotor.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        cbTingkatMotor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih Kategori Harga -",
                "EKONOMIS ≤ 22 juta", "MENENGAH 22 – 35 juta", "PREMIUM > 35 juta" }));
                ...
                jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel11Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(tNoId)
                                        .addComponent(tMotor)
                                        .addComponent(tJenisMotor)
                                        .addGroup(jPanel11Layout.createSequentialGroup()
                                                .addComponent(rbYamaha)
                                                .addGap(18, 18, 18)
                                                .addComponent(rbHonda)
                                                .addGap(0, 106, Short.MAX_VALUE))
                                        .addComponent(cbTingkatMotor, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                Short.MAX_VALUE))
                                .addContainerGap()));
        jPanel11Layout.setVerticalGroup(
                jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel11Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel6)
                                        .addComponent(tMotor, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                ...
                                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jLabel28)
                                        .addComponent(cbTingkatMotor, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(tJenisMotor, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jLabel22))
                ...
                PanelKandidatLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(PanelKandidatLayout.createSequentialGroup()
                                ...
                                .addGroup(PanelKandidatLayout
                                        ...
                                        .addGroup(PanelKandidatLayout.createSequentialGroup()
                                                .addComponent(tombolTambah, javax.swing.GroupLayout.PREFERRED_SIZE, 100,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(18, 18, 18)
                                                .addComponent(tombolEdit, javax.swing.GroupLayout.PREFERRED_SIZE, 100,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                PanelKandidatLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(PanelKandidatLayout.createSequentialGroup()
                                ...
                                .addGroup(PanelKandidatLayout
                                        ...
                                        .addComponent(tombolTambah, javax.swing.GroupLayout.PREFERRED_SIZE, 34,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(tombolEdit, javax.swing.GroupLayout.PREFERRED_SIZE, 34,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(PanelKandidatLayout
    ...
    private void tombolTambahMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_tombolTambahMouseClicked
        ...
        if (!tMotor.getText().equals("") && btnG.getSelection() != null && cbTingkatMotor.getSelectedIndex() != 0
                && !tJenisMotor.getText().equals("") // Fields for motor data entry
    ...
    // private javax.swing.JOptionPane IsiKosong; // Removed - not used
    ...
    private javax.swing.JComboBox<String> cbTingkatMotor;
    ...
    private javax.swing.JTextField tJenisMotor;
