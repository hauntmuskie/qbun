...
public class DialogTambahData extends javax.swing.JDialog {
        ...
        public void setDataTabel(String id_motor, String nama_motor, String merek, String tahun_produksi,
                        String warna_motor,
                        String harga_otr, String kapasitas_mesin, String irit_bahan_bakar, String desain_model,
                ...
                cbWarnaMotor.setSelectedItem(warna_motor);
        ...
        protected void kosong() {
                ...
                cbWarnaMotor.setSelectedIndex(0);
        ...
        private void insertDataPaket() {
                ...
                try {
                        ...
                        stat.setString(5, cbWarnaMotor.getSelectedItem().toString()); // warna_motor
                        stat.setString(6, tJenisMotor.getText()); // harga_otr
                        stat.setString(7, "125 cc"); // Default kapasitas_mesin - should be based on cbmesin selection
                        stat.setString(8, "50 km/l"); // Default irit_bahan_bakar - should be based on cbIritBensin
                        stat.setString(9, cbDesain.getSelectedItem().toString()); // desain_model
                        stat.setString(10, cbTingkatMotor.getSelectedItem().toString()); // kategori_harga
                        stat.setString(11, cbmesin.getSelectedItem().toString()); // kategori_cc
                        stat.setString(12, cbIritBensin.getSelectedItem().toString()); // kategori_irit
                        stat.setString(13, cbDesain.getSelectedItem().toString()); // kategori_desain
                        stat.executeUpdate();
        ...
        private void editDataPaket() {
                try {
                        String sql = "UPDATE data_motor set nama_motor=?, merek=?, tahun_produksi=?, warna_motor=?, harga_otr=?, kapasitas_mesin=?, irit_bahan_bakar=?, desain_model=?, kategori_harga=?, kategori_cc=?, kategori_irit=?, kategori_desain=? WHERE id_motor=?";
                        PreparedStatement stat = conn.prepareStatement(sql);
                        ...
                        stat.setString(4, cbWarnaMotor.getSelectedItem().toString()); // warna_motor
                        stat.setString(5, tJenisMotor.getText()); // harga_otr
                        stat.setString(6, "125 cc"); // Default kapasitas_mesin
                        stat.setString(7, "50 km/l"); // Default irit_bahan_bakar
                        stat.setString(8, cbDesain.getSelectedItem().toString()); // desain_model
                        stat.setString(9, cbTingkatMotor.getSelectedItem().toString()); // kategori_harga
                        stat.setString(10, cbmesin.getSelectedItem().toString()); // kategori_cc
                        stat.setString(11, cbIritBensin.getSelectedItem().toString()); // kategori_irit
                        stat.setString(12, cbDesain.getSelectedItem().toString()); // kategori_desain
                        stat.setString(13, tNoId.getText()); // WHERE clause parameter
        ...
        private void initComponents() {
                ...
                cbWarnaMotor = new javax.swing.JComboBox<>();
                ...
                cbTahunProduksi.setModel(new javax.swing.DefaultComboBoxModel<>(
                                new String[] { "- Pilih Tahun Produksi -", "2020", "2021", "2022", "2023", "2024" }));

                cbWarnaMotor.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
                cbWarnaMotor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih Warna Motor -",
                                "Hitam", "Putih", "Merah", "Biru", "Silver", "Hijau" }));
                ...
                cbTingkatMotor.setModel(
                                new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih Kategori Harga -",
                                                "EKONOMIS ≤ 22 juta", "MENENGAH 22 – 35 juta", "PREMIUM > 35 juta" }));
        ...
        private void tombolTambahMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_tombolTambahMouseClicked
                ...
                if (!tMotor.getText().equals("") && btnG.getSelection() != null
                                && cbTingkatMotor.getSelectedIndex() != 0
                                && !tJenisMotor.getText().equals("") // Fields for motor data entry
                                && cbTahunProduksi.getSelectedIndex() != 0 && cbWarnaMotor.getSelectedIndex() != 0
        ...
        private javax.swing.JComboBox<String> cbWarnaMotor;
