...
public class PengaturanSubKriteria extends javax.swing.JPanel {
            ...
            do{
                ...
                if(n==1){
                    ...
                    if(nTingkatVegetarian == 1){
                        stat.setString(4, cbSubIritBensin1.getSelectedItem().toString());
                        kepentingan="Sangat Penting ke-1";
                    }else if(nTingkatVegetarian == 2){
                        stat.setString(4, cbSubritBensin2.getSelectedItem().toString());
                        kepentingan="Penting ke-2";
                    }else if(nTingkatVegetarian == 3){
                        stat.setString(4, cbSubritBensin3.getSelectedItem().toString());
                        kepentingan="Cukup Penting ke-3";
                    }else{
                        stat.setString(4, ""); // cbSubritBensin4.getSelectedItem().toString() - Component not defined in form
                    ...
                    if(nHargaPaket == 1){
                        stat.setString(4, cbSubMesin1.getSelectedItem().toString());
                        kepentingan="Sangat Penting ke-1";
                    }else if(nHargaPaket == 2){
                        stat.setString(4, cbSubMesin2.getSelectedItem().toString());
                        kepentingan="Cukup Penting ke-2";
                    }else{
                        stat.setString(4, cbSubMesin3.getSelectedItem().toString());
                    ...
                    if(nJumlahMenu == 1){
                        stat.setString(4, cbSubDesain1.getSelectedItem().toString());
                        kepentingan="Sangat Penting ke-1";
                    }else if(nJumlahMenu == 2){
                        stat.setString(4, cbSubDesain2.getSelectedItem().toString());
                        kepentingan="Cukup Penting ke-2";
                    }else{
                        stat.setString(4, cbSubDesain3.getSelectedItem().toString());
                        kepentingan="Biasa ke-3";
                        n++;
                    }
                    stat.setString(5, kepentingan);
            ...
            do{
                ...
                if(n==1){
                    ...
                    if(nTingkatVegetarian == 1){
                        ...
                        stat.setString(3, ""); // cbSubritBensin4.getSelectedItem().toString() - Component not defined in form
                        kepentingan="Biasa ke-4";
                        n++;
                    }
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Kepentingan Harga", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 12), new java.awt.Color(255, 237, 192))); // NOI18N
        ...
        cbSubHarga3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih SubKriteria Harga -", "EKONOMIS ≤ 22 juta", "MENENGAH 22 – 35 juta", "PREMIUM > 35 juta", " " }));

        cbSubHarga2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih SubKriteria Harga -", "EKONOMIS ≤ 22 juta", "MENENGAH 22 – 35 juta", "PREMIUM > 35 juta", " ", " " }));

        cbSubharga1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih SubKriteria Harga -", "EKONOMIS ≤ 22 juta", "MENENGAH 22 – 35 juta", "PREMIUM > 35 juta", " ", " " }));
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addComponent(cbSubHarga3, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(10, 10, 10)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(cbSubHarga2, 0, 197, Short.MAX_VALUE)
        ...
        jLabel17.getAccessibleContext().setAccessibleName("Harga Yang Sangat Penting ke-1");

        jPanel5.setBackground(new java.awt.Color(22, 65, 53));
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Kepentingan Tingkat Irit Bensin", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 12), new java.awt.Color(255, 237, 192))); // NOI18N
        ...
        cbSubritBensin3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- SubKriteria Irit Bensin -", "Irit ≥ 50 km/l", "Sedang 40–49 km/l", "Boros < 40 km/l" }));

        cbSubritBensin2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- SubKriteria Irit Bensin -", "Irit ≥ 50 km/l", "Sedang 40–49 km/l", "Boros < 40 km/l" }));

        cbSubIritBensin1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- SubKriteria Irit Bensin -", "Irit ≥ 50 km/l", "Sedang 40–49 km/l", "Boros < 40 km/l", " " }));
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(cbSubIritBensin1, javax.swing.GroupLayout.Alignment.TRAILING, 0, 212, Short.MAX_VALUE)
                    .addComponent(cbSubritBensin2, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(cbSubritBensin3, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel21)
                    .addComponent(cbSubIritBensin1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel22)
                    .addComponent(cbSubritBensin2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel23)
                    .addComponent(cbSubritBensin3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(22, 22, 22))
        );

        jPanel4.setBackground(new java.awt.Color(22, 65, 53));
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Kepentingan Mesin / CC", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 12), new java.awt.Color(255, 237, 192))); // NOI18N
        ...
        cbSubMesin3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih SubKriteria Mesin / CC -", "Kecil (Entry) 110 – 125 cc", "Sedang (Mid-range) 150 – 160 cc", "Besar (Premium)  > 160 cc" }));

        cbSubMesin2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih SubKriteria Mesin / CC -", "Kecil (Entry) 110 – 125 cc", "Sedang (Mid-range) 150 – 160 cc", "Besar (Premium)  > 160 cc" }));

        cbSubMesin1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih SubKriteria Mesin / CC -", "Kecil (Entry) 110 – 125 cc", "Sedang (Mid-range) 150 – 160 cc", "Besar (Premium)  > 160 cc", " ", " " }));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(cbSubMesin2, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(cbSubMesin3, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(cbSubMesin1, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel9)
                    .addComponent(cbSubMesin1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel15)
                    .addComponent(cbSubMesin2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel16)
                    .addComponent(cbSubMesin3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );

        jPanel6.setBackground(new java.awt.Color(22, 65, 53));
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Kepentingan Desain", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 12), new java.awt.Color(255, 237, 192))); // NOI18N
        ...
        cbSubDesain3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih SubKriteria Desain -", "Sporty/Agresif", "Retro/Stylish", "Futuristik/Modern" }));
        ...
        cbSubDesain2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih SubKriteria Desain -", "Sporty/Agresif", "Retro/Stylish", "Futuristik/Modern" }));

        cbSubDesain1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih SubKriteria Desain -", "Sporty/Agresif", "Retro/Stylish", "Futuristik/Modern" }));
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(cbSubDesain3, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(cbSubDesain2, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(cbSubDesain1, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel10)
                    .addComponent(cbSubDesain1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cbSubDesain2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel25))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cbSubDesain3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel26)))
        );
        ...
        jPanel4.getAccessibleContext().setAccessibleName("Kepentingan Mesin / CC");
