...
public class DataMotor extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tabelDataMotor.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "ID Motor", "Nama Motor ", "Jenis Motor", "Tahun produksi ", "Warna Motor", "HARGA", "MESIN",
                        "Irit Bensin", "Desain"
                }));
        ...
        catatan2.setText("Jika harga motor 20 - 30 Juta cukup input 2 angka awal harga motor");

        catatan1.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        catatan1.setText("Jika harga motor diatas 30 Juta (puluhan) cukup input 3 angka awal harga motor");
